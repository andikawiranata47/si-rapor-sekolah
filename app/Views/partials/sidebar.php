...
<div class="container-fluid page-body-wrapper">
    ...
    <nav class="sidebar sidebar-offcanvas overflow-auto vh-100" id="sidebar">
        <ul class="nav">
            ...
            <?php if (
                is_int(strpos(session()->get('akses'), 'Guru Mata Pelajaran'))
            ...
            <?php if (
                is_int(strpos(session()->get('akses'), 'Guru Monitoring'))
                // || is_int(strpos(session()->get('akses'), 'Admin'))
            ) { ?>
            ...
            <?php if (
                is_int(strpos(session()->get('akses'), 'Pembina Ekstrakurikuler'))
                // || is_int(strpos(session()->get('akses'), 'Admin'))
            ) { ?>
            ...
            <?php if (
                is_int(strpos(session()->get('akses'), 'Guru BK'))
                // || is_int(strpos(session()->get('akses'), 'Admin'))
            ) { ?>
